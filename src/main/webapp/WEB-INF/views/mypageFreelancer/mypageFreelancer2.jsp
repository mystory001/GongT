	...
	<div class="sidemenu-wrap"
		...
		<div class="sidemenu">
			...
			<button type="button" class="button button-update"
				...
				<span style="color: white;">나의 이력서</span>
			</button>
			<button type="button" class="button button-update"
					...
					<table class="table">
						...
						<c:forEach var="ResumeDTO" items="${ResumeDTOList}">
							...
							<tr
								...
								<td
									style="text-align: center !important; font-size: 20px !important;">${ResumeDTO.r_name}</td>
								<td
									style="text-align: center !important; font-size: 20px !important;">${ResumeDTO.r_salary}</td>
