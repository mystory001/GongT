		...
		<div class="main-body-content w-100 ets-pt">
			<div class="table-responsive bg-light">
				<table class="table">
					...
					<%-- 
					일자 : 241207 
					수정내역 : AdminController에서 List객체의 변수명 변경(NoticeDTOList -> noticeDTOList)
					--%>
					<c:forEach var="noticeDTO" items="${noticeDTOList}">
						<div>
							<tr
								onclick="location.href='${pageContext.request.contextPath}/Admin/content?n_num=${noticeDTO.n_num}'">
