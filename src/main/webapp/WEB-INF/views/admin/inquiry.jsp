	...
	<div class="resume-view-page">
		...
		<div class="resume-view-wrapper">
			...
			<div class="resume-view-container" style="height: 700px !important">
				<div class="resume-subject" style="text-align: center !important;">문의
					내역</div>
				...
				<fieldset
					...
					<table class="table">
						...
						<c:forEach var="irDTO" items="${inquiryList }">
							<tr
								onclick="location.href='${pageContext.request.contextPath}/admin/inquiry_content?i_num=${irDTO.i_num}'">
								<td
									style="text-align: center !important; font-size: 15px !important; color: black;">${irDTO.i_num}</td>
								<td
									style="text-align: center !important; font-size: 15px !important; color: black;">${irDTO.i_title}</td>
								<td
									style="text-align: center !important; font-size: 15px !important; color: black;">${irDTO.id}</td>
								<td
									style="text-align: center !important; font-size: 15px !important; color: black;"><fmt:formatDate
										value="${irDTO.i_date}" pattern="yyyy.MM.dd" /></td>
							</tr>
						</c:forEach>
