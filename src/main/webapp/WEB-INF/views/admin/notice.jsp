	...
	<div class="sidemenu-wrap"
		...
		<div class="sidemenu">
			<button type="button" class="button button-update"
				...
				<span onclick="location.href='${pageContext.request.contextPath}/admin/notice'" style="color: white !important;">공지사항</span>
			</button>
			<button type="button" class="button button-update">
				<span onclick="location.href='${pageContext.request.contextPath}/admin/FAQ'">자주 묻는 질문</span>
			</button>
			<button type="button" class="button button-update">
				<span onclick="location.href='${pageContext.request.contextPath}/admin/inquiry'">1:1문의</span>
			</button>
		</div>
	</div>
				...
				<fieldset style="text-align: center; font-size: 20px; width: 100%; height: 80%;">
					<table class="table">
						...
						<c:forEach var="nDTO" items="${noticeList }">
							<tr onclick="location.href='${pageContext.request.contextPath}/admin/content?n_num=${nDTO.n_num}'">
								...
								<td style="text-align: center !important; font-size: 15px !important; color: black;">${nDTO.n_readcount}</td>
							</tr>
					...
					<div id="table_search">
						<form action="${pageContext.request.contextPath}/admin/notice" method="get">
							...
							</select> <input type="text" name="search" class="input_box"> <input type="submit" value="검색" class="btn btn-primary"> <input type="button" value="글목록" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/notice'">
							<c:if test="${sessionScope.id == 'admin'}">
								<input type="button" value="글쓰기" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/write?n_num=${nDTO.n_num}'">
