...
<body>
	...
	<div class="wrappe">
		<div class="conten">
			...
			<form
				action="${pageContext.request.contextPath}/resume/resumeWritePro"
				...
				<fieldset>
					...
					<h3>이력서 제목</h3>
					<input type="text" name="r_name" maxlength="50" required autofocus><br>
					<br>
					<h3>파트너형태</h3>
					...
					</select><br> <sub>※원하시는 직종이 없으시다면 '기타'로 해주시길 바랍니다.</sub> <br> <br>
					<h3>지역</h3>
					...
					<input type="text" name="r_salary" placeholder="0"
						style="font-size: 140%; width: 200px;" required> 만원<br>
					<sub>※만 단위로 입력해주세요.</sub><br> <br>

					<h3>경력</h3>
					<input type="text" name="r_career" placeholder="0"
						style="font-size: 140%; width: 200px;" required> 년<br>
					<sub>※년 단위로 입력해주세요. 경력이 없으시 0으로 입력해주세요.</sub><br> <br>

					<h3>수행한 프로젝트</h3>
					<input type="text" name="r_exp"><br> <sub>※수행한
						프로젝트를 반점(,)으로 구분하며 나열해주세요.</sub><br> <br>

					<h3>첨부 파일</h3>
					<input type="file" name="file"><br> <sub>※첨부할
						파일이 있다면 등록해주세요.(자기소개서, 포트폴리오 등)</sub><br> <br>
