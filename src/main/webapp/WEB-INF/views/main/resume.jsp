					...
					<div class="summary col-4">
						<div class="list list-education">
							...
							<div class="item is-singleline">
								...
								<div class="description">Spring Framework를 이용한 SI 프리랜서 매칭
									플랫폼</div>
							</div>
						...
						<div class="item">
							...
							<div class="content">
								<div class="content-header">
									<div class="name">경상국립대학교 (가좌)</div>
									<div class="line">기계공학부</div>
								</div>
				...
				<div class="sign">
					...
					<div class="warning">
						<div class="description">
							이 이력서는 2024년 02월 13일 (화)에 최종 수정된 이력서 입니다.<br>위조된 문서를 등록하여
							취업/구인활동에 이용 시 법적 책임을 지게 될 수 있습니다.<br>공티는 기업과 구직자가 등록한 문서에 대해
							보증하거나 별도의 책임을 지지 않으며<br>첨부된 문서를 신뢰하여 발생한 법적 분쟁에 책임을 지지 않습니다.<br>또한
							구인/구직 목적 외 다른 목적으로 이용시 공고/이력서 삭제 혹은 비공개 조치가 될 수 있습니다.
						</div>
					</div>
				</div>
		...
		<div class="sidemenu">
			...
			<div class="nav" role="navigation">
				<ul>
					...
					<li><button type="button" class="button button-nav">보유
							기술</button></li>
