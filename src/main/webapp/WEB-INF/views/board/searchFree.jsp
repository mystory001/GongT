		...
		<div class="resume-view-page">
			...
			<div class="resume-view-wrapper">
				...
				<div class="resume-view-container" style="height: 700px !important">
					<div class="resume-subject" style="text-align: center !important;">프리랜서
						찾기</div>
					...
					<fieldset
						...
						<div class="btn-group" role="group" aria-label="Basic example">
							<form
								action="${pageContext.request.contextPath}/board/searchFree"
								method="get">
						...
						<table class="table">
							<thead>
								<tr style="background-color: transparent !important;">
									...
									<th scope="col"
										style="font-size: 20px !important; color: black;">이름</th>
									<th scope="col"
										style="font-size: 20px !important; color: black;">매칭횟수</th>
									<th scope="col"
										style="font-size: 20px !important; color: black;">희망급여</th>
								</tr>
							</thead>
							...
							<c:forEach var="resumeDTO" items="${resumeBoardList }">
								<tr
									...
									<td
										style="text-align: center !important; font-size: 15px !important;">${resumeDTO.r_num}</td>
									<td
										style="text-align: center !important; font-size: 15px !important;">${resumeDTO.r_name}</td>
									<td
										style="text-align: center !important; font-size: 15px !important;">${resumeDTO.name}</td>
									<td
										style="text-align: center !important; font-size: 15px !important;">${resumeDTO.matching }</td>
									<td
										style="text-align: center !important; font-size: 15px !important;">${resumeDTO.r_salary}</td>
								</tr>
							</c:forEach>
						...
						<form action="${pageContext.request.contextPath}/board/searchFree"
							method="get">
							<select name="select">
								<option value="r_name" selected
									style="font-size: 15px !important;">제목</option>
